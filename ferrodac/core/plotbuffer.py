...
class CurveBuffer:
    ...
    def append(self, xs, ys) -> None:
        """Append parallel sequences of x (time) and y (value). Decimates first
        if the new points would exceed `cap`, so the buffer never grows past it."""
